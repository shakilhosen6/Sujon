...
try:
	...
	os.system('xdg-open https://chat.call.whatsapp.com/video/z10Z2T4e5v3d3ZmENC3R3s
#------------------[ GLOBAL NAME ]-------------------#
pretty.install()
CON=sol()
wa = Console()
...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
 SSSSS  HH   HH   AAA   KK  KK IIIII LL      
SS      HH   HH  AAAAA  KK KK   III  LL      
 SSSSS  HHHHHHH AA   AA KKKK    III  LL      
     SS HH   HH AAAAAAA KK KK   III  LL      
 SSSSS  HH   HH AA   AA KK  KK IIIII LLLLLLL 
